...
const LandingPage = () => {
  ...
  useEffect(() => {
    ...
    const forwardParticles = new THREE.Points(
      particlesGeometry,
      particlesMaterial
    );
    ...
    backParticlesGeometry.setAttribute(
      "position",
      new THREE.BufferAttribute(backPositions, 3)
    );
    backParticlesGeometry.setAttribute(
      "color",
      new THREE.BufferAttribute(backColors, 3)
    );
    ...
    const backParticles = new THREE.Points(
      backParticlesGeometry,
      backParticlesMaterial
    );
    ...
    const animate = () => {
      ...
      nodes.forEach((node, index) => {
        ...
        const backPos = backParticles.geometry.attributes.position
      ...
      // Forward propagation
      const forwardPositions = forwardParticles.geometry.attributes.position
        .array as Float32Array;
      for (let i = 0; i < particleCount; i++) {
        const i3 = i * 3;
      ...
      const backPositions = backParticles.geometry.attributes.position
        .array as Float32Array;
      for (let i = 0; i < particleCount; i++) {
        const i3 = i * 3;
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-black via-purple-950 to-gray-900 text-white overflow-hidden">
          ...
          <div className="lg:w-1/2 space-y-8">
            ...
            >
              <p className="text-lg text-gray-300">
                Experience Machine Learning in action—forward passes spark,
                backward updates glow. This neural dance is your gateway to the
                future.
              </p>
      ...
      <CodeBlocks
        ...
        heading={
          <>
            Decode <span className="text-purple-300">Neural Magic</span>
          </>
        }
      ...
      <CodeBlocks
        ...
        heading={
          <>
            Forge Your <span className="text-purple-300">ML Beast</span>
          </>
        }
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 w-full sm:w-11/12 md:w-10/12 lg:w-3/4 mx-auto">
          ...
          <div className="relative bg-gradient-to-br from-black/90 to-gray-900/80 border border-purple-950/70 rounded-lg p-5 sm:p-6 shadow-[0_0_15px_rgba(147,51,234,0.3)] hover:shadow-[0_0_25px_rgba(147,51,234,0.5)] transition-all duration-300">
            ...
            <p className="text-sm sm:text-base text-gray-300">
              ML lets you forge tomorrow’s tech—think self-driving cars, AI
              overlords, and beyond. Be the architect of what’s next.
            </p>
          </div>
          ...
          <div className="relative bg-gradient-to-br from-black/90 to-gray-900/80 border border-purple-950/70 rounded-lg p-5 sm:p-6 shadow-[0_0_15px_rgba(147,51,234,0.3)] hover:shadow-[0_0_25px_rgba(147,51,234,0.5)] transition-all duration-300">
            ...
            <p className="text-sm sm:text-base text-gray-300">
              Turn raw data into power—ML cracks patterns no human could see,
              from stars to stocks. Master the unseen.
            </p>
          </div>
          ...
          <div className="relative bg-gradient-to-br from-black/90 to-gray-900/80 border border-purple-950/70 rounded-lg p-5 sm:p-6 shadow-[0_0_15px_rgba(147,51,234,0.3)] hover:shadow-[0_0_25px_rgba(147,51,234,0.5)] transition-all duration-300">
            ...
            <p className="text-sm sm:text-base text-gray-300">
              Build art, music, or entire worlds—ML isn’t just math; it’s a
              canvas for rebels who code the impossible.
            </p>
          </div>
          ...
          <div className="relative bg-gradient-to-br from-black/90 to-gray-900/80 border border-purple-950/70 rounded-lg p-5 sm:p-6 shadow-[0_0_15px_rgba(147,51,234,0.3)] hover:shadow-[0_0_25px_rgba(147,51,234,0.5)] transition-all duration-300">
            ...
            <p className="text-sm sm:text-base text-gray-300">
              Train AI to obey your will—ML gives you the reins to command tech
              and bend it to your vision.
            </p>
          </div>
        </div>
        <Link
