...
})()(
  {
      ...
      function (require, module, exports) {
        !(function () {
          ...
          function d3_documentElement(node) {
            return (
              node &&
              (node.ownerDocument || node.document || node).documentElement
            );
          }
          ...
          if (d3_document) {
            try {
              ...
              d3_element_prototype.setAttributeNS = function (
                space,
                local,
                value
              ) {
              ...
              d3_style_prototype.setProperty = function (
                name,
                value,
                priority
              ) {
          ...
          d3_selectionPrototype.filter = function (filter) {
            ...
            for (var j = 0, m = this.length; j < m; j++) {
              ...
              for (var i = 0, n = group.length; i < n; i++) {
                if (
                  (node = group[i]) &&
                  filter.call(node, node.__data__, i, j)
                ) {
                  subgroup.push(node);
                }
              }
          ...
          d3.behavior.drag = function () {
            ...
            function dragstart(id, position, subject, move, end) {
              return function () {
                var that = this,
                  target =
                    d3.event.target.correspondingElement || d3.event.target,
                ...
                function ended() {
                  ...
                  dragSubject
                    .on(move + dragName, null)
                    .on(end + dragName, null);
                  dragRestore(dragged);
                  dispatch({
                    type: "dragend",
                  });
          ...
          d3.behavior.zoom = function () {
            ...
            zoom.scaleExtent = function (_) {
              ...
              scaleExtent =
                _ == null ? d3_behavior_zoomInfinity : [+_[0], +_[1]];
              return zoom;
            };
          ...
          function d3_xhr(url, mimeType, response, callback) {
            ...
            return callback == null
              ? xhr
              : xhr.get(d3_xhr_fixCallback(callback));
          }
          ...
          d3.dsv = function (delimiter, mimeType) {
            ...
            function dsv(url, row, callback) {
              ...
              xhr.row = function (_) {
                return arguments.length
                  ? xhr.response(
                      (row = _) == null ? response : typedResponse(_)
                    )
                  : row;
              };
              return xhr;
          ...
          [
            ...
            d3_time[day + "OfYear"] = function (date) {
              var day = d3_time.year(date).getDay();
              return Math.floor(
                (d3_time.dayOfYear(date) + ((day + i) % 7)) / 7
              );
            };
          });
          ...
          function d3_locale_timeFormat(locale) {
            ...
            d3_time_format.multi = d3_time_format.utc.multi =
              d3_time_formatMulti;
          ...
          function d3_geo_clipAntimeridianInterpolate(
            from,
            to,
            direction,
            listener
          ...
          d3.geo.path = function () {
            ...
            path.bounds = function (object) {
              d3_geo_pathBoundsX1 = d3_geo_pathBoundsY1 =
                -(d3_geo_pathBoundsX0 = d3_geo_pathBoundsY0 = Infinity);
          ...
          function d3_geo_circleAngle(cr, point) {
            ...
            return (
              ((-a[2] < 0 ? -angle : angle) + 2 * Math.PI - ε) % (2 * Math.PI)
            );
          }
          ...
          var d3_geo_azimuthalEquidistant = d3_geo_azimuthal(function (
            cosλcosφ
          ) {
          ...
          (d3.geo.transverseMercator = function () {
            var projection = d3_geo_mercatorProjection(
          ...
          function d3_geom_polygonIntersect(c, d, a, b) {
            var x1 = c[0],
              ...
              y43 = b[1] - y3,
              ua =
                (x43 * (y1 - y3) - y43 * (x1 - x3)) / (y43 * x21 - x43 * y21);
          ...
          function d3_geom_voronoiCreateBeach(site) {
            var beach =
              d3_geom_voronoiBeachPool.pop() || new d3_geom_voronoiBeach();
            beach.site = site;
            return beach;
          }
          ...
          function d3_geom_voronoiRemoveBeach(beach) {
            ...
            rArc.edge = d3_geom_voronoiCreateEdge(
              lArc.site,
              rArc.site,
              null,
              vertex
          ...
          function d3_geom_voronoiAttachCircle(arc) {
            ...
            var ha = ax * ax + ay * ay,
              ...
              cy = y + by;
            var circle =
              d3_geom_voronoiCirclePool.pop() || new d3_geom_voronoiCircle();
            circle.arc = arc;
            circle.site = cSite;
            circle.x = x + bx;
          ...
          d3.geom.voronoi = function (points) {
            ...
            voronoi.x = function (_) {
              return arguments.length
                ? ((fx = d3_functor((x = _))), voronoi)
                : x;
            };
            voronoi.y = function (_) {
              return arguments.length
                ? ((fy = d3_functor((y = _))), voronoi)
                : y;
            };
          ...
          var d3_interpolate_numberA =
              /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g,
            d3_interpolate_numberB = new RegExp(
              d3_interpolate_numberA.source,
              "g"
            );
          ...
          d3.interpolators = [
            function (a, b) {
              ...
              return (
                t === "string"
                  ? d3_rgb_names.has(b.toLowerCase()) ||
                    /^(#|rgb\(|hsl\()/i.test(b)
                    ? d3_interpolateRgb
          ...
          d3.ease = function (name) {
            ...
            return d3_ease_clamp(
              m(t.apply(null, d3_arraySlice.call(arguments, 1)))
            );
          };
          ...
          function d3_interpolateRotate(ra, rb, s, q) {
            if (ra !== rb) {
              ...
              q.push({
                i:
                  s.push(d3_interpolateTransformPop(s) + "rotate(", null, ")") -
                  2,
          ...
          function d3_interpolateSkew(wa, wb, s, q) {
            if (wa !== wb) {
              q.push({
                i:
                  s.push(d3_interpolateTransformPop(s) + "skewX(", null, ")") -
                  2,
          ...
          function d3_scale_linearTickFormat(domain, m, format) {
            ...
            if (format) {
              ...
              if (!match[7])
                match[7] =
                  "." + d3_scale_linearFormatPrecision(match[8], range);
              format = match.join("");
            } else {
          ...
          function d3_svg_arcCornerTangents(p0, p1, r1, rc, cw) {
            var x01 = p0[0] - p1[0],
              ...
              D = x1 * y2 - x2 * y1,
              d =
                (dy < 0 ? -1 : 1) * Math.sqrt(Math.max(0, r * r * d2 - D * D)),
              cx0 = (D * dy - dx * d) / d2,
              cy0 = (-D * dx - dy * d) / d2,
              cx1 = (D * dy + dx * d) / d2,
              cy1 = (-D * dx + dy * d) / d2,
          ...
          function d3_selection_interruptNS(ns) {
            return function () {
              ...
              if (
                (lock = this[ns]) &&
                (active = lock[(activeId = lock.active)])
              ) {
                active.timer.c = null;
                active.timer.t = NaN;
          ...
          d3.svg.brush = function () {
            ...
            function brushstart() {
              ...
              if (d3.event.changedTouches) {
                w.on("touchmove.brush", brushmove).on(
                  "touchend.brush",
                  brushend
                );
              } else {
                w.on("mousemove.brush", brushmove).on(
                  "mouseup.brush",
                  brushend
                );
              }
          ...
          function d3_time_scale(linear, methods, format) {
            ...
            scale.nice = function (interval, skip) {
              ...
              function skipped(date) {
                return (
                  !isNaN(date) &&
                  !interval.range(date, d3_time_scaleDate(+date + 1), skip)
                    .length
                );
              }
              return scale.domain(
          ...
          var d3_time_scaleUtcMethods = d3_time_scaleLocalMethods.map(function (
            m
          ) {
            return [m[0].utc, m[1]];
          });
    ...
    2: [
      function (require, module, exports) {
        ...
        function regressPlane(numSamples, noise) {
          var radius = 6;
          var labelScale = d3.scale.linear().domain([-10, 10]).range([-1, 1]);
          ...
          function getLabel(x, y) {
            ...
            gaussians.forEach(function (_a) {
              var cx = _a[0],
                ...
                sign = _a[2];
              var newLabel =
                sign * labelScale(dist({ x: x, y: y }, { x: cx, y: cy }));
        ...
        var HeatMap = (function () {
          function HeatMap(
            ...
            if (this.settings.showAxes) {
              ...
              var yAxis = d3.svg.axis().scale(this.yScale).orient("right");
              this.svg
                .append("g")
                .attr("class", "x axis")
                .attr(
                  "transform",
                  "translate(0," + (height - 2 * padding) + ")"
                )
                .call(xAxis);
              this.svg
                .append("g")
        ...
        function backProp(network, target, errorFunc) {
          ...
          for (var layerIdx = network.length - 1; layerIdx >= 1; layerIdx--) {
            ...
            for (var i = 0; i < currentLayer.length; i++) {
              var node = currentLayer[i];
              node.inputDer =
                node.outputDer * node.activation.der(node.totalInput);
    ...
    6: [
      function (require, module, exports) {
        ...
        var xDomain = [-6, 6];
        var heatMap = new heatmap_1.HeatMap(
          300,
          DENSITY,
          xDomain,
          xDomain,
        ...
        var lineChart = new linechart_1.AppendingLineChart(
          d3.select("#linechart"),
          ["#777", "black"]
        );
        function makeGUI() {
          ...
          var datasetKey = state_1.getKeyFromValue(
            state_1.datasets,
            state.dataset
          );
          ...
          var regDatasetKey = state_1.getKeyFromValue(
            state_1.regDatasets,
            state.regDataset
          );
          ...
          d3.select("label[for='percTrainData'] .value").text(
            state.percTrainData
          );
          ...
          activationDropdown.property(
            "value",
            state_1.getKeyFromValue(state_1.activations, state.activation)
          );
          var learningRate = d3
            .select("#learningRate")
            .on("change", function () {
          ...
          regularDropdown.property(
            "value",
            state_1.getKeyFromValue(
              state_1.regularizations,
          ...
          problem.property(
            "value",
            state_1.getKeyFromValue(state_1.problems, state.problem)
          );
        ...
        function updateBiasesUI(network) {
          nn.forEachNode(network, true, function (node) {
            d3.select("rect#bias-" + node.id).style(
              "fill",
              colorScale(node.bias)
            );
          });
        }
        ...
        function drawNode(cx, cy, nodeId, isInput, container, node) {
          ...
          if (isInput) {
            var label =
              INPUTS[nodeId].label != null ? INPUTS[nodeId].label : nodeId;
          ...
          var nodeHeatMap = new heatmap_1.HeatMap(
            RECT_SIZE,
            DENSITY / 10,
            xDomain,
            xDomain,
        ...
        function drawNetwork(network) {
          ...
          var nodeIndexScale = function (nodeIndex) {
            return nodeIndex * (RECT_SIZE + 25);
          };
          var calloutThumb = d3
            .select(".callout.thumbnail")
            .style("display", "none");
          var calloutWeights = d3
        ...
        function addPlusMinusControl(x, layerIdx) {
          ...
          var firstRow = div
            .append("div")
            .attr("class", "ui-numNodes" + layerIdx);
          firstRow
            .append("button")
        ...
        function updateHoverCard(type, nodeOrLink, coordinates) {
          ...
          var value =
            type === HoverType.WEIGHT ? nodeOrLink.weight : nodeOrLink.bias;
          ...
          d3.select("#network")
            ...
            .each(function (data) {
              data.heatmap.updateBackground(
                heatmap_1.reduceMatrix(boundary[data.id], 10),
                state.discretize
              );
            });
          function zeroPad(n) {
        ...
        function hideControls() {
          ...
          HIDABLE_CONTROLS.forEach(function (_a) {
            ...
            input.on("change", function () {
              ...
              state.serialize();
              userHasInteracted();
              d3.select(".hide-controls-link").attr(
                "href",
        ...
        function generateData(firstTime) {
          ...
          var splitIndex = Math.floor(
            (data.length * state.percTrainData) / 100
          );
      ...
      function (require, module, exports) {
        ...
        var State = (function () {
          ...
          State.deserializeState = function () {
            var map = {};
            for (
              var _i = 0, _a = window.location.hash.slice(1).split("&");
              _i < _a.length;
              _i++
            ) {
              var keyvalue = _a[_i];
              var _b = keyvalue.split("="),
                name_1 = _b[0],
                value = _b[1];
              map[name_1] = value;
            }
            ...
            function hasKey(name) {
              return (
                name in map && map[name] != null && map[name].trim() !== ""
              );
            }
            ...
            State.PROPS.forEach(function (_a) {
              ...
              switch (type) {
                case Type.OBJECT:
                  if (keyMap == null) {
                    throw Error(
                      "A key-value map must be provided for state " +
